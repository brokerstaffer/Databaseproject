-- 0063: Location tab basis becomes multi-select — any subset of office/home/transacted
-- (single kind keeps the fast single-column path; subsets dedup per place+agent).
