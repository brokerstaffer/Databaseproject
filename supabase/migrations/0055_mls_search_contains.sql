-- 0055: MLS search matches anywhere in the full name OR the abbreviation (code),
-- not just the start — 'Contra Costa' finds BECCAR, 'crmls' finds California Regional.
