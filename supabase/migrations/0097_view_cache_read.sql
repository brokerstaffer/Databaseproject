-- 0097: read the 0096 snapshot from the Location and MLS view branches.
-- Unfiltered requests only; any filter, or a cache miss, falls through to the live query.
